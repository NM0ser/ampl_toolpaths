...
#include "stdafx.h"
#include "../../include/translateDialog.h"
...
QT_MOC_LITERAL(1, 16, 28), // "translateDialogButtonClicked"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 23) // "translatePartSlotDialog"

    },
    "translateDialog\0translateDialogButtonClicked\0"
    "\0translatePartSlotDialog"
};
...
void translateDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->translateDialogButtonClicked(); break;
        case 1: _t->translatePartSlotDialog(); break;
        default: ;
        }
        ...
        {
            typedef void (translateDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&translateDialog::translateDialogButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void translateDialog::translateDialogButtonClicked()
{
